                ...
                <div className="my-5 flex justify-between items-start">
                    ...
                    <div className="flex flex-col w-[33%] mr-[5%]">
                        ...
                        {data?.couponStatus === true && 
                            ...
                            >
                                <p className="text-sm mb-1">Coupon ({data?.couponApplied !== null && data?.couponApplied.discountPercent}%)</p>
                                <p className="text-sm font-semibold mb-1 text-red-400">-₹{data?.couponApplied !== null && data?.couponApplied.discountAmount}</p>
                            </div>
                        }
