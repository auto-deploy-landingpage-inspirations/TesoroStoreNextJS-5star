...
export default function BusinessMagic() {
  return (
    <div className='w-full mb-10 pb-10'>
        <h2 className='text-center font-bold text-3xl pb-3 text-[orange]'>
            Small Biz Stars
        </h2>
        ...
        <div className='bg-gradient-smallBiz-section' style={{borderRadius: '20px', marginTop: '20px', padding: '0px 20px 20px 20px'}}>
            <div className='grid lg:grid-cols-9 md:grid-cols-5 gap-8 mt-10' style={{background: 'transparent'}}>
                ...
                <div className='pt-5 col-span-3'>
                    <h2 className='font-bold text-lg pb-5 text-gray-100 text-center cursor-pointer hover-underline-animation'>
                        Manvi & Tanisha | Quoso Home
                    </h2>
                    <p className='pb-10 font-semibold text-gray-300'>
                    ...
                    <a className='underline font-bold text-lg w-full text-center text-gray-100' href="">Shop Their Collection</a>
                </div>
                <div className='col-span-3'>
                    <img className='drop-shadow-2xl' height={'17vh'} src="/assets/images/smallBiz/product-3.jpg" alt="" style={{borderRadius: '10px', transform: 'translateY(-10%)'}}/>   
                </div>
            ...
            <div className='flex w-full'>
                ...
                {showCaseProducts?.map((product, index:number) => (
                    <div key={index} className='w-1/6 hover:drop-shadow-md cursor-pointer ml-10'>
                        ...
                        <p className='font-semibold text-gray-200 mt-4 mb-1 text-sm'>{product.name}</p>
                        <p className='text-lg font-semibold text-gray-300'>Rs. {product.price}/-</p>
                    </div>
                ))}
                
                <div className='w-1/6 ml-10 hover:drop-shadow-md bg-gradient-3 cursor-pointer  max-h-full flex items-center justify-center' style={{aspectRatio: '1/1', borderRadius: '10px'}}>
